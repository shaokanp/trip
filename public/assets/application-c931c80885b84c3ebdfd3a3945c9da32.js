...
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/dashboard/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul id="trips-container">\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/pins/info_form/info_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id="pin-info-form" class="" name="pin">\n    <label name="title" >Title: </label>\n    <input type="text" name="title" value="', title ,'" /><br>\n    <label name="address" >Address: </label>\n    <input type="text" name="address" value="', address ,'" /><br>\n    <label name="time" >Time</label>\n    <input type="text" name="startTime" value="" />\n    <input type="text" name="endTime" value="" /><br>\n    <input id="submit-new-pin-btn" type="button" value="Pin it!" />\n</form>\n\n<!--<form id="pin-info-form" class="border-style1" name="pin">\n    <label name="title" >Title: </label>\n    <input type="text" name="title" value="', title ,'" /><br>\n    <label name="address" >Address: </label>\n    <input type="text" name="address" value="', address ,'" /><br>\n    <label name="time" >Start Time - End Time: </label>\n    <input type="text" name="startTime" value="" /><span> - </span>\n    <input type="text" name="endTime" value="" /><br>\n    <label name="note" >Note:</label>\n    <textarea name="note" value=""></textarea>\n    <input id="submit-new-pin-btn" type="button" value="Pin it!" />\n</form>-->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/pins/pin_cell/pin"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<div class="pin-icon-div">\n    <div pin-type="', pin_type ,'" class="pin-icon"></div>\n</div>\n<div class="pin-text-div border-style1">\n    <div>\n        <span class="pin-title">', title ,'</span><br>\n        <a class="destroy">Delete</a>\n    </div>\n</div>\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/trips/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Edit trip</h1>\n\n<form id="edit-trip" name="trip">\n  <div class="actions">\n    <input type="submit" value="Update Trip" />\n  </div>\n\n</form>\n\n<a href="#/index">Back</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/trips/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<form id="trip-info-form" class="border-style1" name="trip">\n    <label name="title" >Title: </label>\n    <input type="text" name="title" value="', title ,'" /><br>\n    <label name="image" >Cover Image: </label>\n    <input type="text" name="image" value="', image ,'" /><br>\n    <input id="submit-new-trip-btn" type="button" value="Start a New Trip" />\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/trips/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/trips/trip"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<img src="', image ,'" />\n<span>', title ,'</span>\n\n<td><a href="#/', id ,'">Show</td>\n<td><a href="#/', id ,'/edit">Edit</td>\n<td><a href="#/', id ,'/destroy" class="destroy">Destroy</a></td>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/trips/trip_digest"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<img src="', image ,'" />\n<span>', title ,'</span><br>\n\n<a href="trips/', id ,'/destroy" class="destroy">Destroy</a></td>\n');}return __p.join('');};
}).call(this);
(function() {
  var _ref, _ref1,
  ...
  SampleApp.Models.Pin = (function(_super) {
  ...
  SampleApp.Collections.PinsCollection = (function(_super) {
    __extends(PinsCollection, _super);

    function PinsCollection() {
      _ref1 = PinsCollection.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    PinsCollection.prototype.model = SampleApp.Models.Pin;

    PinsCollection.prototype.url = '/pins';
...
(function() {
  ...
  SampleApp.Models.Trip = (function(_super) {
    ...
    Trip.prototype.paramRoot = 'trip';

    Trip.prototype.urlRoot = '/trips';
    ...
    Trip.prototype.initialize = function() {
      return this.pins = new SampleApp.Collections.PinsCollection();
    };
  ...
  SampleApp.Collections.TripsCollection = (function(_super) {
    __extends(TripsCollection, _super);

    function TripsCollection() {
      _ref1 = TripsCollection.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    TripsCollection.prototype.model = SampleApp.Models.Trip;
...
(function() {
  ...
  (_base = SampleApp.Views).Dashboard || (_base.Dashboard = {});

  SampleApp.Views.Dashboard.IndexView = (function(_super) {
    ...
    IndexView.prototype.template = JST["backbone/templates/dashboard/index"];

    IndexView.prototype.initialize = function() {
      return this.options.trips.bind('reset', this.addAll);
    };

    IndexView.prototype.addAll = function() {
      return this.options.trips.each(this.addOne);
    };

    IndexView.prototype.addOne = function(trip) {
      var view;
      view = new SampleApp.Views.Trips.TripDigestView({
        model: trip
      });
      return this.$("#trips-container").append(view.render().el);
    };

    IndexView.prototype.render = function() {
      $(this.el).html(this.template({
        trips: this.options.trips.toJSON()
      }));
      this.addAll();
      return this;
    };
...
(function() {
  ...
  (_base = SampleApp.Views).Pins || (_base.Pins = {});

  SampleApp.Views.Pins.MapView = (function(_super) {
    __extends(MapView, _super);

    function MapView(options) {
      MapView.__super__.constructor.call(this, options);
      this.pins = options.pins;
      this.pins.bind("add", this.addPin);
      this.pins.bind("remove", this.removePin);
    }

    MapView.prototype.render = function() {
      var collection, getTypes, icons, infowindow, init, map, marker, markers, pins, place, pois, request, specific_icon, value;
      ...
      init = function() {
        ...
        console.log(pins);
        return _.each(pins.models, function(pin) {
          marker = new google.maps.Marker;
          return {
            animation: google.maps.Animation.DROP,
            position: new google.maps.LatLng(40.6892494, -74.04450039999999)
          };
        });
      };
      init();
    ...
    MapView.prototype.addPin = function(pin) {};

    MapView.prototype.removePin = function(pin) {};
...
(function() {
  ...
  SampleApp.Views.Pins.NewView = (function(_super) {
    __extends(NewView, _super);

    NewView.prototype.template = JST["backbone/templates/pins/info_form/info_form"];

    NewView.prototype.events = {
      "click #submit-new-pin-btn": "save"
    };

    NewView.prototype.tagName = 'div';

    NewView.prototype.attributes = {
    ...
    function NewView(options) {
      ...
      this.model = new SampleApp.Models.Pin();
    }
    ...
    NewView.prototype.save = function(e) {
      ...
      this.model.set('trip_id', this.trip.id);
      return this.collection.create(this.model.toJSON(), {
        wait: true,
        success: function(pin) {
          return window.location.hash = '';
        },
        error: function(pin, jqXHR) {
    ...
    NewView.prototype.render = function() {
      ...
      this.$("#pin-info-form").backboneLink(this.model);
      return this;
    };
...
(function() {
  ...
  SampleApp.Views.Pins.PinView = (function(_super) {
    __extends(PinView, _super);

    PinView.prototype.template = JST["backbone/templates/pins/pin_cell/pin"];
    ...
    PinView.prototype.tagName = "li";

    PinView.prototype.className = "pin-cell";

    function PinView(options) {
      var _this = this;
      PinView.__super__.constructor.call(this, options);
      this.model.bind("change:errors", function() {
        return _this.render();
      });
      $(this.el).attr('pin-type', SampleApp.Models.Pin.pinType.MEETING);
      $(this.el).attr('id', 'pin_' + this.model.id);
    }

    PinView.prototype.destroy = function() {
      var _this = this;
      this.model.destroy({
        success: function() {
          console.log('delete');
    ...
    PinView.prototype.hightlight = function() {};

    PinView.prototype.edit = function() {
      return window.location.hash = "editpin/" + this.model.id;
    };
  ...
  SampleApp.Views.Pins.PinListView = (function(_super) {
    __extends(PinListView, _super);

    function PinListView() {
      _ref = PinListView.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    PinListView.prototype.initialize = function(options) {
      this.collection.bind('add', this.addPin, this);
    ...
    PinListView.prototype.render = function() {
      var self;
      $(this.el).html('');
      self = this;
      _.each(this.collection.models, function(pin) {
        return self.addPin(pin);
      });
      return this;
    };

    PinListView.prototype.addPin = function(pin) {
      return $(this.el).append(new SampleApp.Views.Pins.PinView({
        model: pin
      }).render().el);
    };
...
(function() {
  ...
  (_base = SampleApp.Views).Trips || (_base.Trips = {});

  SampleApp.Views.Trips.EditView = (function(_super) {
    ...
    EditView.prototype.template = JST["backbone/templates/trips/edit"];
...
(function() {
  ...
  SampleApp.Views.Trips.NewView = (function(_super) {
    __extends(NewView, _super);

    NewView.prototype.template = JST["backbone/templates/trips/new"];
    ...
    NewView.prototype.save = function(e) {
      ...
      return this.collection.create(this.model.toJSON(), {
        success: function(trip) {
          _this.model = trip;
          return window.location = _this.model.urlRoot + '/' + _this.model.id;
        },
        error: function(trip, jqXHR) {
          return _this.model.set({
            errors: $.parseJSON(jqXHR.responseText)
          });
        }
...
(function() {
  ...
  SampleApp.Views.Trips.ShowView = (function(_super) {
    ...
    ShowView.prototype.template = JST["backbone/templates/pins/pin"];

    ShowView.prototype.initialize = function(options) {
      this.listenTo(this.model, 'add', this.addPin);
    ...
    ShowView.prototype.addPin = function(pin) {
      return $(this.el).append(this.template(pin.toJSON()));
    };
...
(function() {
  ...
  SampleApp.Views.Trips.TripDigestView = (function(_super) {
    __extends(TripDigestView, _super);

    function TripDigestView() {
      _ref = TripDigestView.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    TripDigestView.prototype.template = JST["backbone/templates/trips/trip_digest"];

    TripDigestView.prototype.events = {
      "click": "show",
      "click .destroy": "destroy"
    };

    TripDigestView.prototype.tagName = "li";

    TripDigestView.prototype.className = 'trip-digest span2';

    TripDigestView.prototype.destroy = function() {
      this.model.destroy();
      this.remove();
      return false;
    };

    TripDigestView.prototype.render = function() {
      $(this.el).html(this.template(this.model.toJSON()));
      return this;
    };

    TripDigestView.prototype.show = function() {
      return window.location = this.model.urlRoot + '/' + this.model.id;
    };

    return TripDigestView;
...
(function() {
  ...
  SampleApp.Views.Trips.TripView = (function(_super) {
    __extends(TripView, _super);

    function TripView() {
      _ref = TripView.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    TripView.prototype.template = JST["backbone/templates/trips/trip"];

    TripView.prototype.events = {
      "click": "show",
      "click .destroy": "destroy"
    };

    TripView.prototype.tagName = "li";

    TripView.prototype.destroy = function() {
      this.model.destroy();
      this.remove();
      return false;
    };
    ...
    TripView.prototype.show = function() {
      return app.navigate('trips/' + this.model.id, true);
    };
...
(function() {
  ...
  SampleApp.Routers.DashboardRouter = (function(_super) {
    ...
    DashboardRouter.prototype.initialize = function(options) {
      this.trips = new SampleApp.Collections.TripsCollection();
      return this.trips.reset(options.trips);
    };
    ...
    DashboardRouter.prototype.newTrip = function() {
      this.view = new SampleApp.Views.Trips.NewView({
        collection: this.trips
      });
      return $("body").append(this.view.render().el);
    };

    DashboardRouter.prototype.index = function() {
      if (this.view != null) {
        this.view.remove();
      }
      this.view = new SampleApp.Views.Dashboard.IndexView({
        trips: this.trips
      });
      return $("#dashboard").html(this.view.render().el);
    };
...
(function() {
  ...
  SampleApp.Routers.TripsRouter = (function(_super) {
    __extends(TripsRouter, _super);

    function TripsRouter() {
      _ref = TripsRouter.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    TripsRouter.prototype.initialize = function(options) {
      this.trip = new SampleApp.Models.Trip();
      this.trip.set(options.trip);
      this.trip.pins.reset(options.trip.pins);
      return this.before();
    };

    TripsRouter.prototype.routes = {
      "": "show",
      "edit": "edit",
      "newpin": "newPin",
      "editpin/:id": "editPin"
    ...
    TripsRouter.prototype.before = function() {
      var view;
      view = new SampleApp.Views.Pins.PinListView({
        collection: this.trip.pins,
        el: $('#pin-container')
      });
      view.render();
    ...
    TripsRouter.prototype.show = function() {
      if (this.view != null) {
        return this.view.remove();
      }
    };

    TripsRouter.prototype.edit = function() {
      this.view = new SampleApp.Views.Trips.EditView({
        model: this.trip
      });
      return $("#trips").html(this.view.render().el);
    };

    TripsRouter.prototype.newPin = function() {
      this.view = new SampleApp.Views.Pins.NewView({
        trip: this.trip,
        collection: this.trip.pins
      });
      return $("#pin-info-container").html(this.view.render().el);
    };

    TripsRouter.prototype.editPin = function(id) {
      this.view = new SampleApp.Views.Pins.NewView({
        trip: this.trip,
        collection: this.trip.pins
      });
