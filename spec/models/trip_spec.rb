...
describe Trip do
  ...
  describe 'pin association' do
    ...
    let!(:pin2) { FactoryGirl.create(:pin, trip: @trip, title: 'Second Pin', start_time: 1.hour.ago) }
    let!(:pin1) { FactoryGirl.create(:pin, trip: @trip, title: 'First Pin', start_time: 1.day.ago) }
